...
// the aux LEDs are behind the main LEDs, but we want them on all the time anyway
#define USE_INDICATOR_LED_WHILE_RAMPING

// enable blinking indicator LED while off
#define TICK_DURING_STANDBY
#define STANDBY_TICK_SPEED 2  // for this chickenpicture build, 2 gives a fast blip every 4 or so seconds, 3 gives a slightly longer blip every 8 or 9 seconds
